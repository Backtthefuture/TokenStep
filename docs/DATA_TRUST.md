...
| Quota caches | `cache/claude-quota-cache.json` (+ in-memory Codex weekly) | Anthropic usage API; Codex local CLI/app-server (weekly only; 5h retired 2026-08-13) | TTL 15 min |
